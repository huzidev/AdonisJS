        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          {params.id === "me" ? (
            ...
            <>
              ...
              <label htmlFor="roles" className="block text-sm font-medium leading-6 my-2 text-gray-900">Roles</label>
                <select id="roles" className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
s                  {roles.map((role, roleIndex) => (
                    <option key={roleIndex} selected>{role}</option>
                  ))}
                </select>
